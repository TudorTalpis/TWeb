...
const DEMO_PROVIDERS: ProviderProfile[] = [
  {
    ...
    slug: "MariaCleaning",
    description:
      "Top-rated cleaning service with 5+ years of experience. Eco-friendly products and meticulous attention to detail.",
    categoryIds: ["cat1"],
  ...
  },
  {
    ...
    slug: "FitLifeJames",
    description:
      "Certified personal trainer specializing in strength training and weight loss. Customized programs for all levels.",
    categoryIds: ["cat2"],
    pendingCategoryNames: [],
...
const DEMO_SERVICES: Service[] = [
  {
    ...
    description: "Full home cleaning — kitchen, bathrooms, living areas",
    price: 80,
    duration: 120,
    bufferMinutes: 15,
    categoryId: "cat1",
  },
  {
    ...
    providerId: "pp1",
    title: "Deep Cleaning",
    description: "Intensive cleaning including appliances and hard-to-reach areas",
    price: 150,
    duration: 240,
    bufferMinutes: 30,
    categoryId: "cat1",
  },
  {
    ...
    description: "1-on-1 training with custom exercises",
    price: 60,
    duration: 60,
    bufferMinutes: 15,
    categoryId: "cat2",
  },
  {
    ...
    description: "Custom meal plan and dietary guidance",
    price: 45,
    duration: 45,
    bufferMinutes: 15,
    categoryId: "cat2",
  },
  {
    ...
    description: "Professional portrait photography — 20 edited photos",
    price: 120,
    duration: 90,
    bufferMinutes: 20,
    categoryId: "cat3",
  },
  {
    ...
    description: "Full event coverage — unlimited photos",
    price: 350,
    duration: 240,
    bufferMinutes: 30,
    categoryId: "cat3",
