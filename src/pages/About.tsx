...
const team = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545996124-1b5d6b0d9fbd?q=80&w=800&auto=format&fit=crop",
  },
  {
    name: "Marta Rossi",
        ...
        <div className={`${CONTAINER} grid items-center gap-8 lg:grid-cols-2`}>
          <div>
            ...
            <p className="mt-4 max-w-prose text-sm text-muted-foreground sm:text-base">
              ServeHub helps people discover trusted local providers, compare services, and book with clear
              expectations.
            </p>
          ...
          <Card className="rounded-2xl border-border/60 bg-card">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                We focus on clear profiles, real reviews, and straightforward booking flows that reduce friction for
      ...
      <section className="py-14 sm:py-16">
        <div className={CONTAINER}>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The people building a better service marketplace experience.
          </p>
