...
import { Trash2, Plus, Clock, User, CalendarIcon } from "lucide-react";
...
const ProviderSchedule = () => {
  ...
  const [newBooking, setNewBooking] = useState({ clientName: "", serviceId: "", date: "", startTime: "09:00", duration: 60 });
  ...
  const addBooking = () => {
    ...
    setNewBooking({ clientName: "", serviceId: "", date: "", startTime: "09:00", duration: 60 });
