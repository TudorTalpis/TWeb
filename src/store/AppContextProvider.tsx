...
export function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case "LOGIN": {
      ...
      if (!user) {
        // User exists in backend but not in frontend state (e.g., newly signed up user)
        // Create a minimal session with a guest role - the backend token is already saved
