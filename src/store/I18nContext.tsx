...
const translations: Translations = {
  ...
  "auth.rule.upper": { en: "Contains an uppercase letter", ro: "Conține o literă mare", ru: "Содержит заглавную букву" },
  ...
  "auth.error.invalidCredentials": { en: "Invalid name or password.", ro: "Nume sau parolă incorecte.", ru: "Неверное имя или пароль." },
